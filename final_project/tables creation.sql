...
CREATE TABLE std9_121.src_traffic (
	plant bpchar(4) NULL,
	"date" bpchar(10) NULL,
	"time" bpchar(6) NULL,
...
-- Таблица будет содержать дату в нужном формате
...
CREATE TABLE std9_121.src_coupons (
	plant bpchar(4) NULL,
...
SELECT std9_121.f_create_pxf_table( 'src_traffic', 'gp.traffic', 'intern', 'intern');
...
SELECT std9_121.f_create_gpfdist_table('std9_121.src_coupons', 'coupons', '''CSV'' (HEADER DELIMITER '';'' NULL '''' QUOTE ''"'')');
